...
## Tujuan
Dokumen ini berisi pertanyaan untuk menggali kebutuhan stakeholder pada sistem Campus Service Request and Maintenance System. Jawaban dari pertanyaan ini digunakan sebagai dasar pembuatan functional requirement, non-functional requirement, user story, business rule, dan acceptance criteria.
...
## Output Elicitation
Hasil dari elicitation ini digunakan untuk membuat functional requirements, non-functional requirements, business rules, user stories, acceptance criteria, dan traceability matrix.
